...
import {ButtonHover, ButtonHover2} from "./button/hoverButton";
...
export default function HeroSection() {
  return (
    <div className="pt-24 px-5 bg-[#0f0f0f]">
      <main
        className="overflow-hidden"
        style={{
          backgroundImage: `url('/bg/edited-bg.png')`,
          backgroundPosition: "",
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  <div key={1} className="">
                    <ButtonHover text="Join Our Service" url="#" />
                  </div>
                  <ButtonHover2 text="Watch Online" url="#" />
                </AnimatedGroup>
              </div>
            </div>
